...
function stc_content_component_patterns() {
	return [
		...
		'route-timeline' => [
			'content'     => '<!-- wp:group {"className":"stc-content-block stc-content-block--route-timeline","layout":{"type":"constrained"}} --><div class="wp-block-group stc-content-block stc-content-block--route-timeline"><!-- wp:heading --><h2 class="wp-block-heading">A simple first day</h2><!-- /wp:heading --><!-- wp:list {"ordered":true,"className":"stc-content-block__timeline"} --><ol class="wp-block-list stc-content-block__timeline"><!-- wp:list-item --><li><strong>Arrive at Beijing South</strong><span>Follow Metro signs after the ticket gates.</span></li><!-- /wp:list-item --><!-- wp:list-item --><li><strong>Check in near Qianmen</strong><span>Keep the Chinese hotel address ready.</span></li><!-- /wp:list-item --><!-- wp:list-item --><li><strong>Walk to the old city</strong><span>Leave the first evening intentionally light.</span></li><!-- /wp:list-item --></ol><!-- /wp:list --></div><!-- /wp:group -->',
		],
		'checklist'     => [
		...
		'pros-cons'     => [
			'content'     => '<!-- wp:group {"className":"stc-content-block stc-content-block--pros-cons","layout":{"type":"constrained"}} --><div class="wp-block-group stc-content-block stc-content-block--pros-cons"><!-- wp:heading --><h2 class="wp-block-heading">Staying near the old city</h2><!-- /wp:heading --><!-- wp:group {"className":"stc-content-block__pros-cons","layout":{"type":"grid","minimumColumnWidth":"16rem"}} --><div class="wp-block-group stc-content-block__pros-cons"><!-- wp:group {"className":"stc-content-block__pros","layout":{"type":"constrained"}} --><div class="wp-block-group stc-content-block__pros"><!-- wp:heading {"level":3} --><h3 class="wp-block-heading">Works well when</h3><!-- /wp:heading --><!-- wp:list --><ul class="wp-block-list"><!-- wp:list-item --><li>You want to walk to major sights.</li><!-- /wp:list-item --><!-- wp:list-item --><li>You prefer an atmospheric base.</li><!-- /wp:list-item --></ul><!-- /wp:list --></div><!-- /wp:group --><!-- wp:group {"className":"stc-content-block__cons","layout":{"type":"constrained"}} --><div class="wp-block-group stc-content-block__cons"><!-- wp:heading {"level":3} --><h3 class="wp-block-heading">Plan around</h3><!-- /wp:heading --><!-- wp:list --><ul class="wp-block-list"><!-- wp:list-item --><li>Metro transfers may take longer.</li><!-- /wp:list-item --><!-- wp:list-item --><li>Rooms can be smaller.</li><!-- /wp:list-item --></ul><!-- /wp:list --></div><!-- /wp:group --></div><!-- /wp:group --></div><!-- /wp:group -->',
		],
		'faq'           => [
...
function stc_register_content_component_patterns() {
	...
	foreach ( stc_content_component_patterns() as $slug => $pattern ) {
		$component_id = 'comparison' === $slug ? 'comparison_table' : str_replace( '-', '_', $slug );
		...
		register_block_pattern(
			...
			[
				'title'       => sprintf( __( 'Content Component: %s', 'solo-to-china' ), $definition['name'] ),
