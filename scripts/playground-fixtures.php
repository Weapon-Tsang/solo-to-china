...
function stc_playground_component_gallery_content( $media_block ) {
	...
	foreach ( $offer_fixtures as $index => $fixture ) {
		$content .= '<!-- wp:paragraph --><p><strong>LOCAL PREVIEW:</strong> Coupon figures are the requested display copy; this fixture URL does not verify redemption terms.</p><!-- /wp:paragraph -->';
