...
function stc_playground_component_gallery_content( $media_block ) {
	...
	$content .= '<!-- wp:group {"className":"stc-gallery-example stc-gallery-example--affiliate_booking_card","layout":{"type":"constrained"}} --><div class="wp-block-group stc-gallery-example stc-gallery-example--affiliate_booking_card"><!-- wp:shortcode -->[stc_affiliate_booking_card affiliate_asset_id="trip-forbidden-city" provider="Trip.com" asset_type="DEEP_LINK" product_category="ATTRACTION" title="Check Forbidden City ticket options" description="Review listing details and entry conditions before booking." price_text="Check current provider pricing." cta_label="View ticket options" target_url="https://www.trip.com/" disclosure="Affiliate link. SoloToChina may earn a commission at no extra cost to you." scope_type="ENTITY" scope_key="forbidden-city" slot_key="gallery-booking-1" placement="contextual" strategy_version="commercial-v1"]<!-- /wp:shortcode --></div><!-- /wp:group -->';
	$content .= '<!-- wp:group {"className":"stc-gallery-example stc-gallery-example--affiliate_search_card","layout":{"type":"constrained"}} --><div class="wp-block-group stc-gallery-example stc-gallery-example--affiliate_search_card"><!-- wp:shortcode -->[stc_affiliate_search_card affiliate_asset_id="trip-hotel-search" provider="Trip.com" asset_type="SEARCH_BOX" product_category="HOTEL" title="Search hotel options" description="Compare location and arrival access for your dates." cta_label="Search hotels" target_url="https://www.trip.com/hotels/" disclosure="Affiliate link. SoloToChina may earn a commission at no extra cost to you." scope_type="DESTINATION" scope_key="beijing" slot_key="gallery-search-1" placement="contextual" strategy_version="commercial-v1"]<!-- /wp:shortcode --></div><!-- /wp:group -->';
	$content .= '<!-- wp:group {"className":"stc-gallery-example stc-gallery-example--affiliate_banner","layout":{"type":"constrained"}} --><div class="wp-block-group stc-gallery-example stc-gallery-example--affiliate_banner"><!-- wp:shortcode -->[stc_affiliate_banner affiliate_asset_id="trip-planner-banner" provider="Trip.com" asset_type="STATIC_BANNER" product_category="PLANNER" title="Continue planning with Trip.com" description="Check current options and provider terms." cta_label="Open Trip.com" target_url="https://www.trip.com/" image_url="https://pages.trip.com/favicon.ico" alt_text="Trip.com" disclosure="Affiliate link. SoloToChina may earn a commission at no extra cost to you." scope_type="GLOBAL" scope_key="global" slot_key="gallery-banner-1" placement="end_resource" strategy_version="commercial-v1"]<!-- /wp:shortcode --></div><!-- /wp:group -->';
	$content .= '<!-- wp:group {"className":"stc-gallery-example stc-gallery-example--affiliate_promotion_card","layout":{"type":"constrained"}} --><div class="wp-block-group stc-gallery-example stc-gallery-example--affiliate_promotion_card"><!-- wp:shortcode -->[stc_affiliate_promotion_card affiliate_asset_id="trip-campaign" provider="Trip.com" asset_type="PROMOTION" product_category="HOTEL" title="Review the current campaign" description="Confirm campaign dates and provider terms before booking." cta_label="View promotion" target_url="https://www.trip.com/" disclosure="Affiliate promotion. SoloToChina may earn a commission at no extra cost to you." scope_type="COUNTRY" scope_key="china" slot_key="gallery-promotion-1" placement="end_resource" strategy_version="commercial-v1"]<!-- /wp:shortcode --></div><!-- /wp:group -->';
